...
data = [
    ...
    {'Model': 'Qwen-7B', 'Method': 'RP (Baseline)', 'ASR': 0.19, 'Diversity': 0.533, 'Dist_Seed': 1.74},
    {'Model': 'Qwen-7B', 'Method': 'RP + RTer0',    'ASR': 0.26, 'Diversity': 0.46,  'Dist_Seed': 1.65},
    {'Model': 'Qwen-7B', 'Method': 'RP + RTer1',    'ASR': 0.31, 'Diversity': 0.537, 'Dist_Seed': 1.70},
    {'Model': 'Qwen-7B', 'Method': 'RP + User0',    'ASR': 0.17, 'Diversity': 0.52,  'Dist_Seed': 1.68},
    {'Model': 'Qwen-7B', 'Method': 'RP + User1',    'ASR': 0.16, 'Diversity': 0.61,  'Dist_Seed': 1.71},
    ...
    # --- Table 5: GPT-4o-mini ---
    {'Model': 'GPT-4o-mini', 'Method': 'RP (Baseline)', 'ASR': 0.15, 'Diversity': 0.60, 'Dist_Seed': 1.70},
    {'Model': 'GPT-4o-mini', 'Method': 'RP + RTer0',    'ASR': 0.21, 'Diversity': 0.67, 'Dist_Seed': 1.67},
    {'Model': 'GPT-4o-mini', 'Method': 'RP + RTer1',    'ASR': 0.29, 'Diversity': 0.74, 'Dist_Seed': 1.68},
    {'Model': 'GPT-4o-mini', 'Method': 'RP + User0',    'ASR': 0.14, 'Diversity': 0.70, 'Dist_Seed': 1.65},
    {'Model': 'GPT-4o-mini', 'Method': 'RP + User1',    'ASR': 0.15, 'Diversity': 0.74, 'Dist_Seed': 1.70},
    ...
    {'Model': 'GPT-4o-mini', 'Method': 'PG_Users',      'ASR': 0.10, 'Diversity': 0.66, 'Dist_Seed': 1.69},

    # --- Table 6: Qwen2.5-72B-Instruct-Turbo ---
    {'Model': 'Qwen-72B', 'Method': 'RP (Baseline)', 'ASR': 0.10, 'Diversity': 0.62, 'Dist_Seed': 1.68},
    {'Model': 'Qwen-72B', 'Method': 'RP + RTer0',    'ASR': 0.16, 'Diversity': 0.49, 'Dist_Seed': 1.63},
    {'Model': 'Qwen-72B', 'Method': 'RP + RTer1',    'ASR': 0.23, 'Diversity': 0.54, 'Dist_Seed': 1.70},
    {'Model': 'Qwen-72B', 'Method': 'RP + User0',    'ASR': 0.12, 'Diversity': 0.46, 'Dist_Seed': 1.66},
    {'Model': 'Qwen-72B', 'Method': 'RP + User1',    'ASR': 0.10, 'Diversity': 0.63, 'Dist_Seed': 1.67},
    {'Model': 'Qwen-72B', 'Method': 'RP + PG_RTers', 'ASR': 0.15, 'Diversity': 0.60, 'Dist_Seed': 1.73},
    {'Model': 'Qwen-72B', 'Method': 'RP + PG_Users', 'ASR': 0.11, 'Diversity': 0.65, 'Dist_Seed': 1.75},
    {'Model': 'Qwen-72B', 'Method': 'PG_RTers',      'ASR': 0.23, 'Diversity': 0.35, 'Dist_Seed': 1.63},
    {'Model': 'Qwen-72B', 'Method': 'PG_Users',      'ASR': 0.21, 'Diversity': 0.10, 'Dist_Seed': 0.84},

    # --- Table 7: Gemini 2.5 flash ---
    {'Model': 'Gemini Flash', 'Method': 'RP (Baseline)', 'ASR': 0.19, 'Diversity': 0.61, 'Dist_Seed': 1.74},
    {'Model': 'Gemini Flash', 'Method': 'RP + RTer0',    'ASR': 0.23, 'Diversity': 0.62, 'Dist_Seed': 1.63},
    {'Model': 'Gemini Flash', 'Method': 'RP + RTer1',    'ASR': 0.22, 'Diversity': 0.59, 'Dist_Seed': 1.69},
    {'Model': 'Gemini Flash', 'Method': 'RP + User0',    'ASR': 0.16, 'Diversity': 0.57, 'Dist_Seed': 1.67},
    {'Model': 'Gemini Flash', 'Method': 'RP + User1',    'ASR': 0.13, 'Diversity': 0.66, 'Dist_Seed': 1.74},
    {'Model': 'Gemini Flash', 'Method': 'RP + PG_RTers', 'ASR': 0.19, 'Diversity': 0.65, 'Dist_Seed': 1.72},
